lst = [{"id": 1, "title": "Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops", "price": 109.95,
       ...
       {"id": 12, "title": "WD 4TB Gaming Drive Works with Playstation 4 Portable External Hard Drive", "price": 114,
        ...
        "category": "electronics", "image": "https://fakestoreapi.com/img/61mtL65D4cL._AC_SX679_.jpg",
       ...
       {"id": 13, "title": "Acer SB220Q bi 21.5 inches Full HD (1920 x 1080) IPS Ultra-Thin", "price": 599,
        ...
        "category": "electronics", "image": "https://fakestoreapi.com/img/81QpkIctqPL._AC_SX679_.jpg",
       ...
       {"id": 15, "title": "BIYLACLESEN Women's 3-in-1 Snowboard Jacket Winter Coats", "price": 56.99,
        ...
        "category": "women's clothing", "image": "https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_.jpg",
       ...
       {"id": 17, "title": "Rain Jacket Women Windbreaker Striped Climbing Raincoats", "price": 39.99,
        ...
        "category": "women's clothing", "image": "https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879_-2.jpg",
        "rating": {"rate": 3.8, "count": 679}},
       {"id": 18, "title": "MBJ Women's Solid Short Sleeve Boat Neck V ", "price": 9.85,
        "description": "95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach, Lightweight fabric with great stretch for comfort, Ribbed on sleeves and neckline / Double stitching on bottom hem",
        "category": "women's clothing", "image": "https://fakestoreapi.com/img/71z3kpMAYsL._AC_UY879_.jpg",
        "rating": {"rate": 4.7, "count": 130}}, {"id": 19, "title": "Opna Women's Short Sleeve Moisture", "price": 7.95,
...
# new = [d for d in lst if d['category'] in cat]
# a = list(filter(lambda d: d['category'] in cat, lst))

# cat = ["women's clothing"]
# new = [d for d in lst if d['category'] in cat]
# a = list(filter(lambda d: d['category'] in cat, lst))

a = [56, 22, 77, 45, 10, 66, 100, 400, 57, 22, 55, 79, 300, 17, 47, 28, 59, 18, 47, 36, 97, 84, 339, 648, 92]
...
# # print(ab)
# for cate in lst:
#     if cate["category"] in cat:
#         ...  # print(cate)
# group = [lt for lt in lst]
# # print(group)
# # values = set(map(lambda x: x[1], lst))
# # newlist = [[y[0] for y in lst if y[1] == x] for x in lst]
# grouped_items = {}
# for item in lst:
...
#
#
# def bubble_sort_rate(items, key):
#     n = len(items)
#     for i in range(n):
#         for j in range(0, n - i - 1):
#             if items[j][key]['rate'] > items[j + 1][key]['rate']:
#                 items[j], items[j + 1] = items[j + 1], items[j]
#
#
# def selectionSort(array, key):
#     for i in range(len(array) - 1):
#         min_idx = i
#         for idx in range(i + 1, len(array)):
#             if array[idx][key] < array[min_idx][key]:
#                 min_idx = idx
#         array[i], array[min_idx] = array[min_idx], array[i]
#     return array
#
#
# for item in selectionSort(lst, 'price'):
#     print(item)
# # Sort by price
# # bubble_sort(lst, 'price')
# # print("Sorted by price:")
# # for item in lst:
# #     print(item)
# #
# # # Sort by rating
# # bubble_sort_rate(lst, 'rating')
# # print("\nSorted by rating:")
# # for item in lst:
# #     print(item)
#
